...
def main():
    ...
    train_generator_MLE(gen, gen_optimizer, train_samples, MLE_TRAIN_EPOCHS) # pretrain
    ...
    train_discriminator(dis, dis_optimizer, train_samples, gen, 20, 3) # pretrain，20 rounds, 3 epochs per round
    ...
    output_path = os.path.join("./output_0.3_0.3_0.4", dataset)
